            ...
            <div class="bg-white rounded-2xl shadow-lg p-8 mb-8">
                ...
                <div class="grid md:grid-cols-3 gap-6 text-left">
                    <div class="p-4">
                        ...
                        <h3 class="font-semibold text-gray-800 mb-2">Create a Session</h3>
                        <p class="text-gray-600 text-sm">Set up your questions, participant limit, and session duration.</p>
                    </div>

                    <div class="p-4">
                        <div class="text-3xl mb-3">2️⃣</div>
                        <h3 class="font-semibold text-gray-800 mb-2">Share the Link</h3>
                        <p class="text-gray-600 text-sm">Participants join with just a username - no signup required.</p>
                    </div>

                    <div class="p-4">
                        <div class="text-3xl mb-3">3️⃣</div>
                        <h3 class="font-semibold text-gray-800 mb-2">Collect Votes</h3>
                        <p class="text-gray-600 text-sm">See real-time results as participants cast their votes.</p>
                    </div>
                </div>
            </div>
